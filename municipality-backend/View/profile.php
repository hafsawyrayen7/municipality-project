...
<br>
        <div class="card border-info bg-light mb-3" style="width: 18rem; margin: auto">
            ...
            <ul class="list-group list-group-flush">
                <?php if($_GET['type']!="munip") echo '<li class="list-group-item">Tel : '.$profile->getPhone().'</li>';?>
                ...
                if($_GET['type']=="citizen"){
                    ...
                    if($hasadmin==1) echo '<p'.$profile->getAdminId().'&type=admin" class="card-link" >Administrator : </br>'.$adminname.' '.$adminsurname.'</p></li>';
