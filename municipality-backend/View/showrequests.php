        ...
        <?php if($_SESSION['user_type']==1){ echo"<h5>My Requests</h5>";
            ...
            if($data){
                ...
                foreach ($data as $request){
                    $files= array();
                    $folder="";
                    if($request['type']=="Water or Electricity Permit"){
                        $folder="../Documents/Water or Electricity Permit/";
                        $files= explode(",",$request['documents']);
                    }
                    else if($request['type']=="Building Permit"){
                        $folder="../Documents/Building Permit/";
                        $files= explode(",",$request['documents']);
                    }
