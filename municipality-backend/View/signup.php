...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="login.php">
        ...
        Ben Aoun Municipality Administrator</a>
</nav>
...
<div class="wrapper">
    <form class="form-signin" method="post" action="../Controller/validateController.php">
        ...
        Phone:
        <input type="text" class="form-control" name="phone" placeholder="Phone number 8 digits"required/>
        <?php echo '<p class="error"> ' . $errorPhone . '</p>'; ?>
        <br>

        <button class="btn btn-lg btn-dark btn-block" type="submit" name="submit">Sign up</button>
        <a href="login.php" class="btn btn-lg btn-dark btn-block">Log In</a>
    </form>
